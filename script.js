const quizData = [
      ...
      },
      {
        ...
        "b": "Stronger and more motivated.",
        "c": "More competitive.",
        "d": "A better communicator.",
        "correct": "a"
      },

        {
          "question": "Knowingly or unknowingly people tend to lie about things. This can create ----- at your workplace and your personal life.",
        ...
        },
        {
          ...
          },
          {
            ...
            "a": "It was a very crowded bus that day. A lady was standing with her baby and looking for a seat. A young boy sitting there got up and offered his seat to the lady.",
            "b": "A person sees someone in need but ignores them.",
            "c": "A person always avoids helping others to stay out of trouble.",
            "d": "A person only helps others when rewarded.",
            "correct": "a"
          },
          {
            "question": "We realize that we behave in a certain manner with different people and in different circumstances. How does this knowledge help us?",
            "a": "If the behavior is not helping our personal development or our overall progress, we can work on ourselves to improve our responses and actions.",
            "b": "It makes us confused about how to act.",
            "c": "It doesn't help in any way.",
            "d": "It causes us to behave unpredictably.",
            "correct": "a"
          },
          {
            "question": "What is more important is splitting the larger goals in life into",
            "a": "Small achievable targets.",
            "b": "Huge steps without any planning.",
            "c": "Waiting for the right moment.",
            "d": "Always focusing on the bigger picture.",
            "correct": "a"
          },
          {
            "question": "You delay the expected action on the things you have planned. This indicates that",
            "a": "You procrastinate the things.",
            "b": "You are waiting for the right time.",
            "c": "You prioritize other things first.",
            "d": "You manage your time well.",
            "correct": "a"
          },
          {
            "question": "You make way for the ambulance and fire engines when you drive. This indicates",
            "a": "You are aware of your responsibilities.",
            "b": "You are a careful driver.",
            "c": "You are rude to others on the road.",
            "d": "You are unaware of traffic rules.",
            "correct": "a"
          },
          {
            "question": "You attend your office on time. This indicates",
            "a": "You individually follow the rules.",
            "b": "You are rushing through tasks.",
            "c": "You ignore your responsibilities at home.",
            "d": "You feel unmotivated to go to work.",
            "correct": "a"
          },
          {
            "question": "You visit a cloth shop, try many outfits and come out without purchasing anything. You tell the salesman that you do not like anything. You",
            "a": "Feel good about being self-assertive.",
            "b": "Feel guilty for wasting the salesman’s time.",
            "c": "Feel bad for not buying anything.",
            "d": "Feel indifferent to the situation.",
            "correct": "a"
          },
          {
            "question": "You visit a dam with your friends. You see there warning signs on the banks of the dam stating that swimming is prohibited. One of your friends suggests that you should take a dip in the water and play some water games. You would",
            "a": "Stop your friends from going to swim.",
            "b": "Join your friends and swim in the dam.",
            "c": "Ignore the warning signs and swim.",
            "d": "Ask for permission before deciding.",
            "correct": "a"
          }
...
function resetQuiz() {
  ...
  currentQuiz = 0;
  clearInterval(timerInterval);
  timerElement.innerText = 'Time: 25s';
}
